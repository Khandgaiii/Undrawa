...
export const translations: Record<Language, Translations> = {
  ...
  mn: {
    logo: 'Undrawa',
    tagline: 'IoT усны аюулгүй байдал — гоожилт илрүүлэх, хаалт удирдах',
    ...
    leakDetection: 'Гоожилт илрүүлэх',
    telemetry: 'Телеметр',
    leakWarning: 'Гоожилтын төлөв',
    statusNotLeaked: 'Гоожилт илрээгүй',
    criticalWarning: 'Ноцтой анхааруулга',
    waterLeakDetected: 'Усны гоожилт илэрлээ',
